...
<a href="http://en.wikipedia.org/wiki/Censoring_(statistics)">Censored data</a> are data
...
to the analyst if there is a reason you know about that some of the data are missing. You should also not 
<a href="http://en.wikipedia.org/wiki/Imputation_(statistics)">impute</a> /make up/
